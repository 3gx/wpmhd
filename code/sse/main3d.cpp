...
//     gwait = 1;
  ...
  case 8: np.x = 2; np.y = 2; np.z = 2;  break;
  case 16: np.x = 4; np.y = 2; np.z = 2; break;
  case 32: np.x = 4; np.y = 4; np.z = 2; break;
  case 64: np.x = 4; np.y = 4; np.z = 4; break;
  case 128: np.x = 8; np.y = 4; np.z = 4; break;
  case 256: np.x = 8; np.y = 8; np.z = 4; break;
  case 512: np.x = 8; np.y = 8; np.z = 8; break;
  default: 

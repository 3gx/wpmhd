...
public:
  ...
  */
  ...
  float reduce() {return (*this)[0] + (*this)[1] + (*this)[2] + (*this)[3];};
...
//   }
  ...
  static v4sf min(const v4sf x, const v4sf y) {
    return __builtin_ia32_minps(x, y);
  }
  static v4sf max(const v4sf x, const v4sf y) {
    return __builtin_ia32_maxps(x, y);
  }
  static v4sf abs(const v4sf x) {
